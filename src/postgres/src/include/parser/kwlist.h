...
PG_KEYWORD("noprofile", NOPROFILE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("backfill", BACKFILL, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("colocated", COLOCATED, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("nonconcurrently", NONCONCURRENTLY, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("tablegroup", TABLEGROUP, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("tablegroups", TABLEGROUPS, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("tablets", TABLETS, UNRESERVED_KEYWORD, BARE_LABEL)
